...
public class HansungActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    public void onEvent(@Nullable QuerySnapshot value,
                        ...
                        for (QueryDocumentSnapshot doc : value) {
                            if (doc.get("subject") != null) {
                                adapter.addItem(new ChattingItemActivity(doc.getString("subject"), doc.getString("tutor")));
                            }
                        }
                        //어답터 갱신
        ...
        //adapter.addItem(new ChattingItemActivity("객지2", "김동민"));
        //adapter.addItem(new ChattingItemActivity("자료구조", "유예은"));
        //adapter.addItem(new ChattingItemActivity("알고리즘", "최유진"));
        //어댑터에 연결
