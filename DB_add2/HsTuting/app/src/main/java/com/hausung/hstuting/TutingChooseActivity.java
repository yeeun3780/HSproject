...
public class TutingChooseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tuting_search);
        initializeViews();

        hansungBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TutingChooseActivity.this, HansungActivity.class);
        ...
        departmentBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TutingChooseActivity.this, DepartmentActivity.class);
                startActivity(intent);
            }
        });
    }
